...
--
-- Table structure for table `mm_ad_group`
--

DROP TABLE IF EXISTS `mm_ad_group`;
...
--
-- Dumping data for table `mm_ad_group`
--

LOCK TABLES `mm_ad_group` WRITE;
/*!40000 ALTER TABLE `mm_ad_group` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `mm_ad_group` ENABLE KEYS */;
UNLOCK TABLES;
