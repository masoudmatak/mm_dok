...
--
-- Table structure for table `mm_gallring`
--

DROP TABLE IF EXISTS `mm_gallring`;
...
--
-- Dumping data for table `mm_gallring`
--

LOCK TABLES `mm_gallring` WRITE;
/*!40000 ALTER TABLE `mm_gallring` DISABLE KEYS */;
INSERT INTO `mm_gallring` VALUES (1,'faktura',90,'720'),(2,'polis_anmalan',1500,'5000');
/*!40000 ALTER TABLE `mm_gallring` ENABLE KEYS */;
UNLOCK TABLES;
